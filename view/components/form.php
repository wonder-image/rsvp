<?php
     ...
     *
     * Override consumer: `custom/view/components/rsvp/form.php`.
     */
    ...
    <div class="content content-medium">
        ...
        <?php } else { ?>
            ...
            <form 
                ...
                <div>
                    <div class="text fw-500 w-100"><?= __t('pages.rsvp.form.contacts_label') ?></div>
                    <div id="rsvp-decline-contact" class="w-100 d-grid col-2 gap-5 gap-p-3 mt-2" style="display:none !important;">
...
(() => {
    ...
    function guestHTML(index) {
        ...
        return guestTemplate.innerHTML
            .split('__INDEX__')
            .join(String(index))
    ...
    function renderGuests() {
        ...
        participantsBox.querySelectorAll('.wi-input, .wi-checkbox').forEach((el) => {
            changeInputId(el);
        });
    ...
    window.addEventListener('loaded', () => {
        ...
        if (participantSelectWrap) {
            participantSelectWrap.addEventListener('click', (e) => {
                if (e.target.closest('.wi-input-list-value')) renderGuests();
            });
        } else if (participantsCount) {
