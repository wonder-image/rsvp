...
final class Response extends Model
{
    ...
    public static function tableSchema(): array
    {
        $schema = [
            ...
            Column::key('company')->length(255)->null(),
            Column::key('participants')->type('LONGTEXT'),
            ...
            Column::key('events')->type('LONGTEXT')->null(),
            Column::key('consents')->type('LONGTEXT')->null(),
            Column::key('legal_documents')->type('LONGTEXT')->null(),
            Column::key('metadata')->type('LONGTEXT')->null(),
    ...
    public static function dataSchema(): array
    {
        $schema = [
            ...
            Field::key('company')->text()->sanitizeFirst(),
            Field::key('participants')->text()->required()->json()->sanitize(false),
            ...
            Field::key('events')->text()->json()->sanitize(false),
            Field::key('consents')->text()->json()->sanitize(false),
            Field::key('legal_documents')->text()->json()->sanitize(false),
            Field::key('metadata')->text()->json()->sanitize(false),
